<?php
    if ( function_exists( 'vc_add_shortcode_param' ) ) {
        ...
        vc_add_shortcode_param( 'fl_custom_products_categories', 'fl_custom_products_category_settings_field');

    }

if ( ! function_exists( 'fl_custom_products_category' ) ) :
    function fl_custom_products_category_settings_field( $settings, $value ) {

...
/*------------------------------------------------
         CARD FLIP SHORTCODE
------------------------------------------------*/
function kswr_cardflip_shortcode(){
    vc_map( array(
        "name" => esc_html__( "Card Flip", "kaswara" ),
        "description" => esc_html__("Flip box with content and cool style", "kaswara"),         
        'icon' => KASWARA_IMAGES.'small/cardflip.jpg',  
        "category" => "Kaswara",        
        "base" => "kswr_cardflip",      
        "params" => array(      
            ...
            array(
                "type" => "kswr_switcher",
                "group" => "General", 
                "heading" => esc_html__( "Use Smooth Effect", "kaswara" ),
                "param_name" => "cflp_transition",
                'default' => '0',
            ...
            array(
                ...
                "param_name" => "cflp_container_radius",
                "value" => 0,
                "group" => 'General' 
             ),      
             array(
            ...
            array(
                ...
                'group' => 'General',
                'param_name' => 'cflp_columnposition',
                'value' => array(
            ...
            array(
                ...
                "param_name" => "cflp_front_subtitle",            
                "group" => "Front",
            ), 
            array(
                "type" => "kswr_switcher",
            ...
            array(
                "type" => "attach_image",
                'group' => 'Front',
                "dependency" => Array("element" => "cflp_img_enable","value" => array('1')),            
            ...
            array(
             ...
             array(
                ...
                "dependency" => Array("element" => "cflp_img_enable","value" => array('0')),                            
                "description" =>esc_html__("Choose Your Icon","kaswara"),
                "param_name" => "cflp_icon",
                "value" => "",
                "group" => "Front",
            ),  
             //Front Styling
            ...
            array(
                ...
                "param_name" => "cflp_front_style_def",
                'default' => '1',
                'on' => array('text' => 'ON','val' => '1' ),
                'off'=> array('text' => 'OFF','val' => '0') 
            ), 
            array(
                "type" => "colorpicker",
                "group" => "Front",   
                "dependency" => Array("element" => "cflp_front_style_def","value" => array('0')),           
                "value" => "#333",
                "heading" => esc_html__( "Title Color", "kaswara" ),
                "param_name" => "cflp_front_title_color"
            ),
            array(
                "type" => "colorpicker",
                "group" => "Front",            
                ...
                "param_name" => "cflp_front_subtitle_color"
            ),
            array(
                'type' => 'dropdown',
            ...
            array(
                "type" => "attach_image",
                "dependency" => Array("element" => "cflp_front_bg_type","value" => array('image')),                         
                'group' => 'Front',
                "heading" => esc_html__( "Upload Image", "kaswara" ),
                "param_name" => "cflp_front_backgroundimage_img"
            ),
            array(
                ...
                "dependency" => Array("element" => "cflp_front_bg_type","value" => array('image')),                         
                "param_name" => "cflp_front_backgroundimage",
                "mtop" => "10px"
            ),
             ...
             array(
                ...
                "dependency" => Array("element" => "cflp_front_bg_type","value" => array('color')),                         
                "heading" => esc_html__( "Container Background", "kaswara" ),
                "param_name" => "cflp_front_background"
            ),
            array(
                "type" => "kswr_border",
            ...
            array(
                ...
                "dependency" => Array("element" => "cflp_front_style_def","value" => array("0")),                    
                "group" => "Front",                 
                "param_name" => "cflp_icon_br"
            ),
            array(
                "type" => "kswr_number",
                "heading" => esc_html__( "Border Radius", "kaswara" ),
                "param_name" => "cflp_icon_br_radius",
                "dependency" => Array("element" => "cflp_front_style_def","value" => array('0')),            
                "value" => 0,
                "group" => 'Front' 
            ),  
            ...
            array(
                "type" => "textfield",
                "heading" => esc_html__( "Title", "kaswara" ),
                "param_name" => "cflp_back_title",            
                "group" => "Back"
            ),
            array(
                "type" => "textfield",
                "heading" => esc_html__( "Sub Title", "kaswara" ),
                "param_name" => "cflp_back_subtitle",            
                "group" => "Back",
            ), 
            array(
                "type" => "textfield",
                "heading" => esc_html__( "Button Text", "kaswara" ),
                "param_name" => "cflp_back_button",            
                "group" => "Back",
            ),
            array(
                "type" => "vc_link",
                "heading" => esc_html__( "Button Link", "kaswara" ),
                "param_name" => "cflp_back_button_link",            
                "group" => "Back",
            ), 
            //Back Styling
             array(
            ...
            array(
                ...
                "group" => "Back", 
                "heading" => esc_html__( "Use Default Styling", "kaswara" ),
                "param_name" => "cflp_back_style_def",
                'default' => '1',
                'on' => array('text' => 'ON','val' => '1' ),
                'off'=> array('text' => 'OFF','val' => '0') 
            ), 
            array(
                "type" => "colorpicker",
                "group" => "Back",   
                "dependency" => Array("element" => "cflp_back_style_def","value" => array('0')),           
                "value" => "#333",
                "heading" => esc_html__( "Title Color", "kaswara" ),
                "param_name" => "cflp_back_title_color"
            ),
            array(
                "type" => "colorpicker",
                "group" => "Back",            
                ...
                "dependency" => Array("element" => "cflp_back_style_def","value" => array('0')),   
                "heading" => esc_html__( "Sub Title Color", "kaswara" ),
                "param_name" => "cflp_back_subtitle_color"
            ),
             array(
                'type' => 'dropdown',
                'heading' => esc_html__( 'Choose Background Type', 'kaswara' ),
             ...
             array(
                "type" => "attach_image",
                "dependency" => Array("element" => "cflp_back_bg_type","value" => array('image')),                         
                'group' => 'Back',
                "heading" => esc_html__( "Upload Image", "kaswara" ),
                "param_name" => "cflp_back_backgroundimage_img"
            ),
             array(
                "type" => "kswr_background",
                "group" => "Back",
                "heading" => esc_html__( "Background Image Settings", "kaswara" ), 
                "dependency" => Array("element" => "cflp_back_bg_type","value" => array('image')),                         
                "param_name" => "cflp_back_backgroundimage",
                "mtop" => "10px"
            ),
             array(
                "type" => "kswr_gradient",
                "group" => "Back",            
                "value" => '{"type":"color", "color1":"transparent", "color2":"transparent", "direction":"to left"}',
                "dependency" => Array("element" => "cflp_back_bg_type","value" => array('color')),                         
                "heading" => esc_html__( "Container Background", "kaswara" ),
                "param_name" => "cflp_back_background"
            ),
            array(
                "type" => "kswr_border",
                'bordergradient' => 'enable',
            ...
            array(
                ...
                "param_name" => "cflp_back_button_height",
                "dependency" => Array("element" => "cflp_back_style_def","value" => array('0')),            
                "value" => 45,
                "group" => 'Back' 
            ),
            array(
                ...
                "param_name" => "cflp_back_button_color"
            ),
            array(
                "type" => "kswr_gradient",
                "group" => "Back",            
                ...
                "param_name" => "cflp_back_button_bgcolor"
            ),
            array(
                "type" => "kswr_border",
                ...
                "group" => "Back",                 
                'bordergradient' => 'enable',
                "param_name" => "cflp_back_button_border"
            ),
            array(
                "type" => "kswr_number",
                "heading" => esc_html__( "Button Border Radius", "kaswara" ),
                "param_name" => "cflp_back_button_br_radius",
                "dependency" => Array("element" => "cflp_back_style_def","value" => array('0')),            
                "value" => 0,
                "group" => 'Back' 
            ),
            ...
            array(
                "type" => "kswr_message",
                "group" => "Typography",
                "dependency" => Array("element" => "cflp_font_def","value" => array('0')),            
            ...
            array(
                "type" => "kswr_fontsize",
                "param_name" => "cflp_front_title_fsize",
                "group" => "Typography",                 
             ...
             array(
                "type" => "kswr_fontstyle",
                "param_name" => "cflp_front_title_fstyle",
             ...
             array(
                "type" => "kswr_fontsize",
                "param_name" => "cflp_front_subtitle_fsize",
                "group" => "Typography",                 
             ...
             array(
                "type" => "kswr_fontstyle",
                "param_name" => "cflp_front_subtitle_fstyle",
            ...
            array(
                "type" => "kswr_fontsize",
                "param_name" => "cflp_back_title_fsize",
                "group" => "Typography",                 
                "heading" => esc_html__( "Title Font Size", "kaswara" ),
                "dependency" => Array("element" => "cflp_font_def","value" => array("0")),                               
                "defaults"=> array("font-size" => "21px", "line-height" => "", "letter-spacing" => "",),
             ...
             array(
                "type" => "kswr_fontstyle",
                "param_name" => "cflp_back_title_fstyle",
                "heading" => esc_html__( "Title Font Style", "kaswara" ),       
                "dependency" => Array("element" => "cflp_font_def","value" => array("0")),                                  
                "defaults"=> array("font-family" => "Inherit", "font-weight" => "inherit", "font-style" => ""),
                'elements'  => array(
             ...
             array(
                "type" => "kswr_fontsize",
                "param_name" => "cflp_back_subtitle_fsize",
                "group" => "Typography",                 
                "heading" => esc_html__( "Sub Title Font Size", "kaswara" ),
                "dependency" => Array("element" => "cflp_font_def","value" => array("0")),                               
                "defaults"=> array("font-size" => "16px", "line-height" => "", "letter-spacing" => "",),
             ...
             array(
                "type" => "kswr_fontstyle",
                "param_name" => "cflp_back_subtitle_fstyle",
                "heading" => esc_html__( "Sub Title Font Style", "kaswara" ),       
                "dependency" => Array("element" => "cflp_font_def","value" => array("0")),                                  
                "defaults"=> array("font-family" => "Inherit", "font-weight" => "inherit", "font-style" => ""),
                'elements'  => array(
              ...
              array(
                "type" => "kswr_fontsize",
                "param_name" => "cflp_back_button_fsize",
                "group" => "Typography",                 
             ...
             array(
                "type" => "kswr_fontstyle",
                "param_name" => "cflp_back_button_fstyle",
            ...
            array(
             ...
             array(
                "type" => "kswr_distance",
                "distance" => "margin",            
                "param_name" => "cflp_front_title_mr",
            ...
            array(
                "type" => "kswr_distance",
                "distance" => "margin",            
                "param_name" => "cflp_front_subtitle_mr",
            ...
            array(
                "type" => "kswr_distance",
                "distance" => "margin",            
                "param_name" => "cflp_back_subtitle_mr",
                "heading" => esc_html__( "Sub Title Margins", "kaswara" ),
                "positions" => array(
                    esc_html__("Top","kaswara") => "top",
                    esc_html__("Bottom","kaswara") => "bottom"
            ...
            array(
                "type" => "kswr_distance",
                "distance" => "margin",            
                "param_name" => "cflp_back_button_mr",
            ...
            array(
                "type" => "kswr_distance",
                "distance" => "padding",            
                "param_name" => "cflp_back_button_pd",
...
add_action( 'init', 'kswr_cardflip_shortcode' ); 
?>